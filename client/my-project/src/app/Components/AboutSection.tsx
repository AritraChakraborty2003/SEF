    ...
    <section className="py-16 bg-gray-100 text-black">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 px-4">
        ...
        <div className="md:w-1/2 w-full">
          ...
          <p className="text-lg mb-4">
            We are a Section 8 non-profit organization dedicated to transforming
            education by empowering teachers. Our mission is to provide
            innovative training, resources, and support to educators, enabling
            them to inspire and nurture the next generation of learners.
          </p>
          <p className="text-lg mb-4">
            Through workshops, mentorship, and community programs, we bridge the
            gap between traditional teaching methods and modern educational
            needs. We believe that by investing in teachers, we invest in the
